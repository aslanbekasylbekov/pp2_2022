...
-------------------------------------------------- --------------------  ------  ------''')
for i in range(3):
    print(data['imdata'][i]["l1PhysIf"]['attributes']["dn"]
    +"                              "
    +data['imdata'][i]["l1PhysIf"]['attributes']["descr"]
    +data['imdata'][i]["l1PhysIf"]['attributes']["speed"]
    +"   "
    +data['imdata'][i]["l1PhysIf"]['attributes']["mtu"])
